...
from utils.eval import eval_performance_bias, eval_clinical_performance, eval_rgb_model, eval_rgb_model_2
...
def parseArgs():
    ...
    parser.add_argument('-ckpt','--checkpoint-path', type=str,
                        default="/share1/home/zhouwenqing/Fusion-Vital/ckpt/rgb/best.pth",
...
def main(args):
    ...
    # maes_val, rmses_val, pccs_val, hr_test = eval_rgb_model(video_list=v_test, model=model, device=args.device)
    maes_test, hr_test = eval_rgb_model_2(destination_folder, v_test, model, device=args.device)
